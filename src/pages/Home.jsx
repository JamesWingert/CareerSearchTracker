export default function Home() {
  return (
    <div className="container mx-auto bg-base-100 pt-8 pb-24">
      <div className="px-4 sm:px-6 sm:text-center md:max-w-6xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center mt-16">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex">
            <div >
              <h1 className="text-4xl tracking-tight font-extrabold  sm:leading-none lg:text-5xl xl:text-6xl text-center items-center ">
                <span className="md:block text-error">Apply more</span>
                <span className=" md:block">track less.</span>
              </h1>
