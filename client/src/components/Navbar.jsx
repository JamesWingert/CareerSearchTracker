              ...
              >
                <div className="rounded-lg shadow-md bg-base-100 ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="px-5 pt-4 flex items-center justify-between">
                    ...
                    <div className="-mr-2">
                      <Popover.Button className="bg-base-100 rounded-md p-2 inline-flex items-center justify-center hover:text-error  focus:outline-none   focus:ring-error">
                  ...
                  <div className="flex justify-center pb-4">
                    <button
                      href="/"
                      className="btn block  px-5 uppercase text-center font-medium max-w-xs tracking-wider text-md  border-2 rounded-md  bg-base-100 text-error border-error hover:bg-base-300 hover:border-error"
                      onClick={logoutUser}
                    >
                      Log out
                    </button>
