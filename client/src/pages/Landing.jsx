            ...
            <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex ">
              <div>
                ...
                <p className=" md:block text-2xl mt-10 ">
                  ...
                  applications and keep track of your progress. It keeps track
                  of the company, the position, the status of the application,
                  the date of the application, and other statistics.
                </p>
              </div>
            </div>
